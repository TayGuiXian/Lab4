...
public class TCPframe  extends JFrame implements ActionListener
{
	...
	public TCPframe()
	{
		...
		this.setTitle("TCP Application: Translation Client");
		...
		this.tittle = new JLabel("Words to translate: ");
	...
	// set font style for arabic and korean words
	...
	{	
		if(e.getSource()== bm)
		{
			...
			TranslateClientApplication.btnPressed();
		}
